...
//获取教师信息
export const getCourseTeacherinfoById = id => {
  return http.requestQuickGet(apiUrl+'/course/courseteacherinfo/get/'+id)
}
//更新教师信息
export const updateCourseTeacherinfo =(id,courseTeacherinfo) => {
  return http.requestPost(apiUrl+'/course/courseteacherinfo/update/'+id,courseTeacherinfo)
}
/*保存媒资信息*/
